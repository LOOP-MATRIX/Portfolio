...
const Home = () => {
  ...
  const routes = ['/','/education', '/experience', '/projects'];
  ...
  return (
    <>
      <div className="flex w-full h-screen text-white bg-[linear-gradient(45deg,#000000,#131530)] bg-[length:400%_400%] animate-[gradient_15s_ease_infinite]">
